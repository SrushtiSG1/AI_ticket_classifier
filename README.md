It's a machine learning–based system that automatically classifies customer support tickets, predicts their priority, 
...
Text processing using vectorization
Machine learning model integration (BERT + traditional ML models)
